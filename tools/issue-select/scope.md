...
- Repo: `codepath/pathreview-ai301-fa26-s3` <!-- path review repo for this course -->
...
I'm comfortable with Python and JavaScript, with some experience in web development and CLI tools. I want to improve my skills in open-source contribution workflows and debugging. I prefer issues that involve clear reproduction steps and bounded scope; I'd like to avoid large refactors or design-heavy tasks for my first contribution.
