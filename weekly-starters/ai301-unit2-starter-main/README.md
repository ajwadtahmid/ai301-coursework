...
Activity, and Check-In tabs for Unit 2); this repo is the package those
pages tell you to install and run.

## What's here

- `skill/`: the repro-check skill for Claude Code, complete except for
  three files: `skill/rubric.md`, `skill/references/evidence-guide.md`,
  and `skill/voice-guide.md` ship as templates. Filling them is the
  Unit 2 deliverable.
...
Copy the whole `skill/` folder to `~/.claude/skills/repro-check/`
...
runs and live runs share one canonical set.
